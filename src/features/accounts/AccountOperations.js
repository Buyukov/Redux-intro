...
function AccountOperations() {
  ...
  function handleDeposit() {
    if(!depositAmount) return alert("There is no Deposit.!");
  ...
  function handleWithdrawal() {
    if(!withdrawalAmount) return alert("There is no withdrowalAmount.!");
    dispatch(withdraw(withdrawalAmount));
    setWithdrawalAmount("");
  };
 
  function handleRequestLoan() {
    if(!loanAmount || !loanPurpose) return alert("Please write down loanAmount or LoanPurpose.!")
